        ...
        try {
            ...
            while(rs.next()) {
                ...
                String insertSQL = String.format("insert into emp_10 values(%s, '%s', '%s', %s, '%s', %s, %s, %s)",
                        empno, ename, job, mgr, hiredate, sal, comm, deptno); // 전체 넣을때는 칼럼명 안써도된다.
            ...
            if(stmt1 != null) try {rs.close();} catch(SQLException e) {}
            if(stmt2 != null) try {rs.close();} catch(SQLException e) {}
